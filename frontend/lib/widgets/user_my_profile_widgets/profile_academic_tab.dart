...
class ProfileAcademicTab extends StatelessWidget {
  ...
  const ProfileAcademicTab(
      {super.key, required this.user, required this.requiredHours});

  @override
  Widget build(BuildContext context) {
    final computedEndDate =
        user?['estimated_end_date']?.toString().trim() ?? '';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Expanded(
                  child: CleanInfoCard(
                      ...
                      value: getProfileVal(user, 'start_date'),
          ...
          const ProfileSectionTitle(
              title: 'Placement Details', icon: Icons.work_rounded),
          const SizedBox(height: 12),
          Row(
            children: [
              Expanded(
              ...
              Expanded(
                  child: CleanInfoCard(
                      label: 'Intern Number',
                      value: getProfileVal(user, 'intern_number'),
          ...
          Row(
            children: [
              ...
              Expanded(
                  ...
                  child: CleanInfoCard(
                      label: 'Year Level',
                      value: getProfileVal(user, 'year_level'))),
            ],
          ),
          const SizedBox(height: 12),
          CleanInfoCard(
              label: 'Program / Course', value: getProfileVal(user, 'program')),
          const SizedBox(height: 12),
          CleanInfoCard(
              label: 'Specialization',
              value: getProfileVal(user, 'specialization')),
        ],
      ),
    );
  }

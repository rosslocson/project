          ...
          children: [
            Text(
              ...
              style: TextStyle(
                ...
                color: isArchivedView ? Colors.grey.shade700 : (isActiveUser ? Colors.black87 : Colors.grey),
                decoration: (!isActiveUser && !isArchivedView) ? TextDecoration.lineThrough : null,
              ),
            ),
            if (isCurrentUser) ...[
        ...
        subtitle: Column(
          ...
          children: [
            Text(user['email'] ?? '',
                style: TextStyle(
                    fontSize: 11,
                    color: isArchivedView ? Colors.grey.shade500 : (isActiveUser ? Colors.black54 : Colors.grey.shade400))),
            if ((user['department'] as String? ?? '').isNotEmpty)
              Text(
                '${user['department']} · ${user['position'] ?? ''}',
                style: TextStyle(
                    fontSize: 10,
                    color: isArchivedView ? Colors.grey.shade400 : (isActiveUser ? Colors.black38 : Colors.grey.shade400)),
              ),
          ],
        ),
        trailing: Row(
          ...
          children: [
            ...
            if (isArchivedView)
              ...
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                decoration: BoxDecoration(
                  color: isActiveUser ? Colors.green.shade50 : Colors.yellow.shade100,
                  borderRadius: BorderRadius.circular(20),
                ),
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 11,
                    fontWeight: FontWeight.w600,
                    color: isActiveUser ? Colors.green.shade800 : Colors.yellow.shade900,
                  ),
                ),
              ),
            ...
            if (!isArchivedView)
              Tooltip(
                message: isActiveUser ? 'Deactivate user' : 'Activate user',
              ...
              Tooltip(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(
                      color: isCurrentUser ? Colors.transparent : Colors.grey.shade200, width: 1,
                    ),
                  ),
                  child: IconButton(
                    iconSize: 18, padding: EdgeInsets.zero,
                    icon: Icon(Icons.archive_outlined, color: isCurrentUser ? Colors.grey.shade300 : Colors.blueGrey.shade400),

...
class ProfileFormTab extends StatelessWidget {
  ...
  Widget _dropdownField({required String label, required String? value, required String hint, required List<String> items, required void Function(String?)? onChanged}) =>
      Container(
        height: 52,
          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  if (profileMsg != null) ...[
                    StatusMessageBanner(msg: profileMsg!, success: profileSuccess),
                  ...
                  _dropdownField(
                    label: 'Department',
                    value: selectedDept,
                    hint: isLoadingDepartments ? 'Loading departments...' : (departments.isEmpty ? 'N/A' : 'Select Department'),
                    items: departments,

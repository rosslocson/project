...
class UserAccountStatusBanner extends StatelessWidget {
  ...
  const UserAccountStatusBanner({super.key, required this.msg, required this.success});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(success ? Icons.check_circle : Icons.error_outline, color: success ? Colors.green : Colors.red, size: 18),
